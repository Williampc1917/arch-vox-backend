...
from app.services.google_oauth_service import validate_google_token_permissions
...
async def validate_oauth_permissions(token: OAuthToken) -> Dict[str, Any]:
    ...
    try:
        ...
        validation_result = {
            ...
            "recommendations": _generate_permission_recommendations(permission_validation, health_status),
        }
...
def _generate_permission_recommendations(permission_validation: Dict, health_status: Dict) -> list[Dict]:
...
async def check_gmail_calendar_health() -> Dict[str, Any]:
    ...
    try:
        ...
        # Add summary
        healthy_components = sum(1 for comp in health_data["components"].values() if comp.get("healthy", False))
...
async def validate_user_oauth_setup(user_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from app.services.gmail_connection_service import get_gmail_status
