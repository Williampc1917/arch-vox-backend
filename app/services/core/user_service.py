...
async def get_user_profile(user_id: str) -> UserProfile | None:
    ...
    SELECT
        ...
        u.vip_onboarding_skipped,
        u.vip_acquisition_status,
        u.vip_last_attempt_at,
    ...
    try:
        ...
        profile = UserProfile(
            ...
            vip_onboarding_skipped=vip_onboarding_skipped,
            vip_acquisition_status=vip_acquisition_status or "active",
            vip_last_attempt_at=vip_last_attempt_at,
