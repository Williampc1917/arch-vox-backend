...
from app.services.email_style.rate_limiter import (
    RateLimitExceeded,
...
class EmailStyleService:
    ...
    async def get_email_style_options(self, user_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from app.services.email_style.rate_limiter import get_email_extraction_status
    ...
    async def create_custom_style_with_rate_limiting(
        ...
        try:
            ...
            try:
                from app.services.core.openai_service import extract_custom_email_style
            ...
            raise EmailStyleError(f"3-profile style creation failed: {e}", user_id=user_id) from e
...
async def create_custom_email_style(user_id: str, labeled_emails: dict[str, str]) -> dict[str, Any]:
    """Create 3 custom email styles with rate limiting."""
    return await email_style_service.create_custom_style_with_rate_limiting(user_id, labeled_emails)
