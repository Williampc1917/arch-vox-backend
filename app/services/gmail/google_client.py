...
class GoogleGmailService:
    ...
    async def send_message(
        ...
        try:
            ...
            response = await self._request_with_retry("POST", url, headers=headers, json=send_data)
    ...
    async def create_draft(
        ...
        try:
            ...
            response = await self._request_with_retry("POST", url, headers=headers, json=draft_data)
    ...
    async def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                response = await self._request_with_retry("HEAD", GMAIL_API_BASE_URL, timeout=5.0)
