...
from app.models.domain.gmail_domain import GmailConnectionStatus
...
from app.services.infrastructure.google_oauth_service import (
    ...
    validate_google_token_permissions,
)
from app.services.infrastructure.oauth_state_service import (
    OAuthStateError,
...
class GmailConnectionService:
    ...
    async def _update_calendar_status_if_granted(self, user_id: str, scope: str) -> None:
        ...
        try:
            ...
            if has_calendar_access:
                ...
                from app.services.calendar.operations_service import _update_user_calendar_status
    ...
    async def _complete_oauth_database_updates(self, user_id: str, token_response) -> bool:
        ...
        try:
            ...
            from app.services.infrastructure.encryption_service import encrypt_oauth_tokens
