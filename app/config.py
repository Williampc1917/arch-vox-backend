...
class Settings(BaseSettings):
    ...
    VIP_BACKFILL_STUCK_TIMEOUT_MINUTES: int = 30
    VIP_BACKFILL_MAX_AUTO_RETRIES: int = 1
    VIP_BACKFILL_RETRY_TTL_SECONDS: int = 86400
    VIP_BACKFILL_WATCHDOG_INTERVAL_SECONDS: int = 60
